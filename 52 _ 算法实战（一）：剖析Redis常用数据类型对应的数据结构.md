...
好了，今天我就带你一块儿看下，**<span class="orange">经典数据库Redis中的常用数据类型，底层都是用哪种数据结构实现的？</span>
...
![](<https://static001.geekbang.org/resource/image/2e/69/2e2f2e5a2fe25d26dc2fc04cfe88f869.jpg>)
